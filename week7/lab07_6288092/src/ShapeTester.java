...
public class ShapeTester {
	   public static void main(String[] args) {
	      ...
	      Shape s6 = new Circle("Gold", 5);
	      System.out.println(s6);  // Run Circle's toString()
	      System.out.println("Area is " + s6.getArea());  // Run Circle's getArea()
	       
	      Circle s7 = new Circle();  // Upcast
	      s7.setColor("Grey");
	      System.out.println("--Test overload method--");
	      System.out.println("Area is " + s7.getArea(3.14));  // Run Circle's getArea()
	      System.out.println(s7);  // Run Circle's toString()
	   }
	}
